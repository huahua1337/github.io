...
window.Win10 = {
    ...
    _init:function () {
        ...
        //打广告
        setTimeout(function () {
            console.log(Win10.huahua('huahua1337\n更多信息：huahua1337.cn,轻松打造别具一格的后台界面 ','The page is strongly driven by huahua1337.\nFor more info: huahua1337.cn, easy to create a unique background interface.'))
        },2000);
        //点击清空右键菜单
